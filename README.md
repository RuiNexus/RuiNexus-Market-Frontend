...
我们认可用户的反馈：“开源的不如魔方市场付费的”。  
没有稳定的收入来源，维护动力自然会减弱。**因此 RuiNexus Market 插件将停止开发与更新。**

- 当前 v1.x 为最终版本，不再提供任何功能改进或 Bug 修复
- 原已知功能限制（线下交易、手续费、邮箱等）将永久保持现状
- 强烈建议所有用户迁移至魔方市场官方付费插件，以获取更完善的功能与持续支持

👉 **推荐替代方案（付费）**：[魔方市场 - 二手服务器交易系统](https://my.idcsmart.com/shop/shop_detail.html?id=2466&clientId=6278)
...
| 功能 | 状态 | 配置建议 |
|---|---|---|
| 线下交易 | ⚠️ 可能无法正常使用 | 请在插件后台**禁用**线下交易模式 |
| 手续费比例(%) | ⚠️ 可能无法正常使用 | 请在插件后台设置为 **0** |
